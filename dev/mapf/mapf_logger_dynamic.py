...
def write_dynamic_obstacle_only_frame(map_name, composite_map, output_root, cell_size=DEFAULT_PNG_CELL_SIZE, visually_free_vertex_positions=None, nest_by_map=True):
    renderer = _build_renderer(cell_size)
    output_path = _get_map_output_dir(map_name, output_root, nest_by_map=nest_by_map) / 'config_000.png'
...
def write_dynamic_showcase_frame(map_name, composite_map, output_root, cell_size=DEFAULT_PNG_CELL_SIZE, visually_free_vertex_positions=None, nest_by_map=True):
    renderer = _build_renderer(cell_size)
    output_path = _get_map_output_dir(map_name, output_root, nest_by_map=nest_by_map) / 'config_001.png'
...
def write_dynamic_setup_frame(map_name, composite_map, agents, output_root, cell_size=DEFAULT_PNG_CELL_SIZE, visually_free_vertex_positions=None, nest_by_map=True):
    renderer = _build_renderer(cell_size)
    output_path = _get_map_output_dir(map_name, output_root, nest_by_map=nest_by_map) / 'config_002.png'
...
def write_dynamic_mapf_frames(map_name, composite_loop, dynamic_matrix_loop, agents, paths_by_agent, output_root, cell_size=DEFAULT_PNG_CELL_SIZE, visually_free_vertex_positions=None, nest_by_map=True):
    renderer = _build_renderer(cell_size)
    output_dir = _get_map_output_dir(map_name, output_root, nest_by_map=nest_by_map)
