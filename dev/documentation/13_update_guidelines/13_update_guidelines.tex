...
\begin{enumerate}[leftmargin=2em]
    ...
    \item the relevant solver or mapping modules,
...
Downstream reading, analysis, or prompting may depend on the current output tree and JSON/CSV file names. Renaming those outputs should be treated as a deliberate interface change.
...
\begin{itemize}[leftmargin=2em]
    ...
    \item whether the 8-neighbor clearance rule is still being enforced.
\end{itemize}
