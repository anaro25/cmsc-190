...
\begin{itemize}[leftmargin=2em]
    ...
    \item \texttt{dev/master\_config.py} is the intended user-editable configuration file for the main experiment.
    \item \texttt{dev/master\_config\_ref\_comparison.py} is the separate user-editable configuration file for the supplementary reference comparison.
