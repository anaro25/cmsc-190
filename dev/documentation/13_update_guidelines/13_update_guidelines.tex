...
The project now stores branch-local raw MAPF payloads under \texttt{dev/raw\_mapf\_data/<map\_type>/}. Those payloads are reused manually through \texttt{recompute\_MAPF} rather than validated automatically against code or configuration. If compute-stage data shape changes, update both the writer/reader logic and the documentation, and assume older saved payloads may need manual replacement.
