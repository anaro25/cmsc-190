...
So the branch no longer acts like a fully scattered dynamic baseline. It now studies what happens when one agent group begins as a clustered local group, with the exact compact-versus-spaced cluster geometry controlled globally by \texttt{compact\_clustering}, and must spread toward dispersed destinations while the environment changes over time.
