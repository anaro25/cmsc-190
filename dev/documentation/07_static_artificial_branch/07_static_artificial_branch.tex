...
\begin{itemize}[leftmargin=2em]
    ...
    \item \texttt{static\_campus\_area\_2}, a semantic image-based campus branch.
\end{itemize}
...
This new branch uses the campus-area-2 image as a \emph{static} semantic map rather than a dynamic branch source. The campus loader keeps the meaning of the image colors:
\begin{itemize}[leftmargin=2em]
...
\begin{itemize}[leftmargin=2em]
    ...
    \item a clustered goal set from the other campus zone, sampled as one directly adjacent group,
...
\begin{itemize}[leftmargin=2em]
    ...
    \item \texttt{static\_campus\_area\_2}: what the mapping difference looks like on a semantically meaningful real image while still avoiding time variation.
\end{itemize}
