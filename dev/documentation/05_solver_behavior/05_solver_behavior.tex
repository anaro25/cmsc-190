...
\section{Main-Experiment Low-Level Guidance}

The main experiment uses Manhattan distance as the low-level A* heuristic for both classical and cyclic mapping. Graph-aware static shortest-path distance is not used in main-experiment branches.

The remaining branch-local low-level-planning boolean in \texttt{master\_config.py} is:
\begin{lstlisting}
tight_time_horizon = ...
\end{lstlisting}
