...
The comparison is organized across nine map types:
\begin{enumerate}[leftmargin=2em]
    ...
    \item \texttt{static\_campus\_area\_3},
    \item \texttt{dynamic\_campus\_area\_3}.
\end{enumerate}
...
The nine map types are not cosmetic labels. They differ in meaningful ways:
\begin{itemize}[leftmargin=2em]
...
Traditional branches use one-to-one MAPF assignments for dispersed or clustered targets. Campus crowd-simulation branches use a target-only \texttt{single} goal mode, where all agents share one literal target cell in a different campus zone and disappear there after arrival.
