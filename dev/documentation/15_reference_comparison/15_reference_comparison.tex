...
If \texttt{to\_generate = "raw\_data"}, the selected reference case is executed and raw data is saved. If \texttt{to\_generate = "graphs"} or \texttt{to\_generate = "visualization"}, existing raw data is reused.
